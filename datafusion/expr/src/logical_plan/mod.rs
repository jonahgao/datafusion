...
pub use plan::{
    ...
    JoinConstraint, JoinType, Limit, LiteralFetch, LogicalPlan, Partitioning, PlanType,
    Prepare, Projection, RecursiveQuery, Repartition, Sort, StringifiedPlan, Subquery,
